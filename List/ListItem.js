...
function getStyles(props, context, state) {
  ...
  var styles = {
    ...
    innerDiv: {
      marginRight: nestedLevel * listItem.nestedLevelDepth,
      paddingLeft: rightIcon || rightAvatar || rightIconButton ? 56 : rightToggle ? 72 : 16,
      paddingRight: leftIcon || leftAvatar || leftCheckbox || insetChildren ? 72 : 16,
